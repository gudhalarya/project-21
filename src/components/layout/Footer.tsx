      ...
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start mb-16 space-y-12 md:space-y-0">
          <div className="max-w-md">
            <h2 className="text-4xl font-extrabold uppercase tracking-tighter mb-6">Career</h2>
            ...
            <div>
              ...
              <ul className="space-y-4 uppercase tracking-widest text-xs font-bold">
                <li className="flex items-center space-x-2">
                  ...
                  <a
                    href="https://www.instagram.com/_careereducationgroup?igsh=ZmY3dHNyZGc1bnYx&utm_source=qr"
                    target="_blank"
                    rel="noreferrer"
                ...
                <li className="flex items-center space-x-2">
                  ...
                  <a
                    href="https://www.facebook.com/share/18CE7t6pgJ/?mibextid=wwXIfr"
                    target="_blank"
                    rel="noreferrer"
                    className="hover:opacity-70 transition-opacity"
                  >
                ...
                <li className="flex items-center space-x-2">
                  ...
                  <a
                    href="https://youtube.com/@careersmartlearner?si=0xx5utQhvC2EtzQW"
                    target="_blank"
                    rel="noreferrer"
                    className="hover:opacity-70 transition-opacity"
                  >
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <p className="text-[10px] uppercase tracking-widest text-white/30">
            &copy; 2026 Career Coaching Institute. All rights reserved.
          </p>
